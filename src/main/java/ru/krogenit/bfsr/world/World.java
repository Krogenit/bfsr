...
import ru.krogenit.bfsr.collision.ContactListener;
...
public class World {
	...
	protected org.dyn4j.dynamics.World physicWorld;
	...
	private void initPhysicWorld() {
		physicWorld = new org.dyn4j.dynamics.World();
		physicWorld.setGravity(org.dyn4j.dynamics.World.ZERO_GRAVITY);
		...
		physicWorld.addListener(new ContactListener());
//		physicWorld.addListener(new CollisionListener());
	...
	public org.dyn4j.dynamics.World getPhysicWorld() {
		return physicWorld;
	}
