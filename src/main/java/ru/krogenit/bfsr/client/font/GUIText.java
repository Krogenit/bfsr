...
public class GUIText {
	...
	@Getter @Setter private String textString;
	@Getter @Setter private Vector2f fontSize;

	@Getter private int textMeshVao;
	@Getter @Setter private int vertexCount;
	private final Vector4f color;

	private Vector2f position;
	@Getter private float maxLineSize;
	@Setter private int numberOfLines;

	@Getter private final FontType font;

	@Getter private final boolean centered;
	@Getter @Setter private EnumZoomFactor zoomFactor = EnumZoomFactor.Gui;
	@Getter private EnumParticlePositionType positionType;
	@Getter @Setter private float lineWidth;
	@Getter @Setter private boolean removed;
	@Getter private boolean shadow = true;
	@Getter private float lineHeight = 1.0f;
