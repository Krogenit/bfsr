...
public class BulletPlasmSmall extends Bullet {
	...
	public BulletPlasmSmall(WorldServer world, int id, float radRot, Vector2f pos, Ship ship) {
		super(world, id, 15f, radRot, pos, new Vector2f(24, 24), ship, new Vector4f(0.5f, 0.5f, 1.0f, 1.5f), 1.68f, new BulletDamage(5f, 2.5f, 2.5f));
	}

	public BulletPlasmSmall(WorldClient world, int id, float radRot, Vector2f pos, Ship ship) {
		super(world, id, 15f, radRot, pos, new Vector2f(24, 24), ship, TextureRegister.smallPlasm, new Vector4f(0.5f, 0.5f, 1.0f, 1.5f), 1.68f, new BulletDamage(5f, 2.5f, 2.5f));
	}
