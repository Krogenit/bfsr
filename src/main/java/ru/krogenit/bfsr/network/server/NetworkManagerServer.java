...
import ru.krogenit.bfsr.network.packet.common.PacketKeepAlive;
...
import ru.krogenit.bfsr.network.packet.server.PacketRemoveObject;
...
public class NetworkManagerServer extends NetworkManager {
    ...
    @Getter @Setter private LoginState loginState = LoginState.HELLO;
    private int timeout;
    private String playerName, password;
    private boolean registration;

    private int networkTickCount;
    @Getter private int currentTimeInt;
