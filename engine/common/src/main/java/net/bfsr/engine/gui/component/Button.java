...
public class Button extends TexturedGuiObject {
    ...
    public Button(TextureRegister texture, int x, int y, int width, int height, String string, FontType fontType, int fontSize,
                  int stringXOffset, int stringYOffset,
    ...
    public Button(TextureRegister texture, int x, int y, int width, int height, String string, FontType fontType, int fontSize,
                  int stringYOffset, Runnable onMouseClickRunnable) {
        this(texture, x, y, width, height, string, fontType, fontSize, width / 2, stringYOffset, StringOffsetType.CENTERED,
                onMouseClickRunnable);
    }

    public Button(TextureRegister texture, int x, int y, int width, int height, String string, FontType fontType, int fontSize,
                  Runnable onMouseClickRunnable) {
    ...
    public Button(TextureRegister texture, int width, int height, String string, FontType fontType, int fontSize,
                  int stringYOffset, Runnable onMouseClickRunnable) {
