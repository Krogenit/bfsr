...
public abstract class AbstractSpriteRenderer {
    ...
    public abstract void render(int count, FloatBuffer vertexBuffer, ByteBuffer materialBuffer);

    public abstract AbstractBuffersHolder getBuffersHolder(BufferType bufferType);

    public abstract void add(float lastX, float lastY, float x, float y, float scaleX, float scaleY, float r, float g, float b, float a,
                             AbstractTexture texture, BufferType bufferType);
    public abstract void add(float x, float y, float scaleX, float scaleY, float r, float g, float b, float a, AbstractTexture texture, BufferType bufferType);

    public abstract void addToRenderPipeLineSinCos(float lastX, float lastY, float x, float y, float lastSin, float lastCos, float sin, float cos,
                                                   float lastScaleX, float lastScaleY, float scaleX, float scaleY, float r, float g, float b, float a,
                                                   AbstractTexture texture, BufferType bufferType);
    public abstract void addToRenderPipeLineSinCos(float lastX, float lastY, float x, float y, float lastSin, float lastCos, float sin, float cos, float scaleX,
                                                   float scaleY, float r, float g, float b, float a, AbstractTexture texture, BufferType bufferType);
    public abstract void addToRenderPipeLineSinCos(float lastX, float lastY, float x, float y, float sin, float cos, float scaleX, float scaleY,
    ...
    public abstract void putVertices(float x1, float y1, float x2, float y2, float x3, float y3, float x4, float y4, FloatBuffer floatBuffer,
                                     MutableInt bufferIndex);
    public abstract void putVertices(float lastX, float lastY, float x, float y, float lastSin, float lastCos, float sin, float cos,
                                     float lastScaleX, float lastScaleY, float scaleX, float scaleY, float interpolation, FloatBuffer floatBuffer,
                                     MutableInt bufferIndex);
    public abstract void putVerticesCentered(float x, float y, float sin, float cos, float halfSizeX, float halfSizeY, FloatBuffer floatBuffer,
                                             MutableInt bufferIndex);
    ...
    public abstract void putMaterialData(long maskTextureHandle, float fireAmount, float fireUVAnimation, ByteBuffer byteBuffer, MutableInt bufferIndex);
}