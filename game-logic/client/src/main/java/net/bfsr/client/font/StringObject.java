...
public class StringObject extends SimpleGuiObject {
    ...
    protected final AbstractGLString glString = Engine.renderer.stringRenderer.createGLString();
    ...
    public StringObject compile() {
        Engine.renderer.stringGeometryBuilder.createString(glString, stringCache, string, 0, 0, fontSize, color.x, color.y, color.z, color.w, stringOffsetType);
        return this;
    }
    ...
    @Override
    public void render() {
        Engine.renderer.stringRenderer.addStringInterpolated(glString, lastX, lastY, x, y, BufferType.GUI);
    }

    @Override
    public void renderNoInterpolation() {
        Engine.renderer.stringRenderer.addString(glString, x, y, BufferType.GUI);
    }

    public void render(BufferType bufferType) {
        Engine.renderer.stringRenderer.addString(glString, bufferType);
    }

    public void render(BufferType bufferType, float x, float y) {
        Engine.renderer.stringRenderer.addString(glString, x, y, bufferType);
    }

    public void render(BufferType bufferType, float x, float y, float scaleX, float scaleY) {
        Engine.renderer.stringRenderer.addString(glString, x, y, scaleX, scaleY, bufferType);
    }

    public void render(BufferType bufferType, float lastX, float lastY, float x, float y, float scaleX, float scaleY) {
        Engine.renderer.stringRenderer.addString(glString, lastX, lastY, x, y, scaleX, scaleY, bufferType);
    }
    ...
    public void renderWithShadow(BufferType bufferType, float lastX, float lastY, float x, float y, float scaleX, float scaleY, float shadowOffsetX, float shadowOffsetY) {
        Engine.renderer.stringRenderer.addStringWithShadow(glString, lastX, lastY, x, y, scaleX, scaleY, shadowOffsetX, shadowOffsetY, bufferType);
    }
