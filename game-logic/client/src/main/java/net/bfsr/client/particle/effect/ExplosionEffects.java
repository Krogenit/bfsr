...
public final class ExplosionEffects {
    private static final ParticleEffect shipDestroySmall = Client.get().getParticleEffect("explosion/ship_small");
    private static final ParticleEffect smallExplosion = Client.get().getParticleEffect("explosion/small");
