...
@NoArgsConstructor
@Getter
@PacketAnnotation(id = PacketIdRegistry.ENTITY_SYNC_DAMAGE)
public class PacketEntitySyncDamage extends PacketScheduled {
    ...
    public PacketEntitySyncDamage(DamageableRigidBody damageable, double timestamp) {
        super(timestamp);
