...
public final class ByteBufUtils {
    ...
    public static Polygon readPolygon(ByteBuf byteBuf) {
        ...
        LinearRing linearRing = DamageSystem.GEOMETRY_FACTORY.createLinearRing(coordinates);
        ...
        if (holesCount > 0) {
            ...
            for (int i = 0; i < holesCount; i++) {
                ...
                coordinates[count] = coordinates[0];
                holes[i] = DamageSystem.GEOMETRY_FACTORY.createLinearRing(coordinates);
            }
        }

        return DamageSystem.GEOMETRY_FACTORY.createPolygon(linearRing, holes);
    }
}