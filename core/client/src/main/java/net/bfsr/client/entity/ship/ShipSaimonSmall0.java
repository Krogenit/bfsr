...
public class ShipSaimonSmall0 extends Ship {
    ...
    public void spawnEngineParticles(Direction direction) {
        ...
        if (direction == Direction.FORWARD) {
            ...
            RotationHelper.rotate(rotation, -3.3f, 0, CollisionObjectUtils.ROTATE_TO_VECTOR);
            ...
            EngineEffects.smallEngine(shipPos.x + CollisionObjectUtils.ROTATE_TO_VECTOR.x, shipPos.y + CollisionObjectUtils.ROTATE_TO_VECTOR.y, rotation, 10.0f,
                    (float) shipVelocity.x / 50.0f, (float) shipVelocity.y / 50.0f, 1.0f, 0.5f, 0.5f, 1.0f, engineSpawnAccumulator);
    ...
    public void renderAdditive() {
        if (moveDirection == Direction.FORWARD) {
            Vector2f shipPos = getPosition();
            float rotation = getRotation();
            RotationHelper.rotate(rotation, -3.5f, 0, CollisionObjectUtils.ROTATE_TO_VECTOR);
