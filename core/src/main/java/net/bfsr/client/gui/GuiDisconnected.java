...
public class GuiDisconnected extends Gui {
    ...
    protected void initElements() {
        ...
        registerGuiObject(new StaticString(FontType.XOLONIUM, errorMessage, 16).compile().atCenter(-172, -62));
        registerGuiObject(new StaticString(FontType.XOLONIUM, description, 16).compile().atCenter(-172, -34));
    }
}
