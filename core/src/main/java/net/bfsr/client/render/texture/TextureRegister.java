...
public enum TextureRegister {
    ...
    shieldStation0("component/shield/station0"),

    ambientBackground1("ambient/background/background1"),

    ambientCloud0("ambient/cloud/cloud0"),
    ambientCloud1("ambient/cloud/cloud1"),
    ambientCloud2("ambient/cloud/cloud2"),
    ambientCloud3("ambient/cloud/cloud3"),
    ambientCloud4("ambient/cloud/cloud4"),
    ambientCloud5("ambient/cloud/cloud5"),
    ambientCloud6("ambient/cloud/cloud6"),
    ambientCloud7("ambient/cloud/cloud7"),
