...
public class WeaponPlasmSmall extends WeaponSlot {
    public WeaponPlasmSmall(Ship ship) {
        super(ship, new SoundRegistry[]{SoundRegistry.weaponShootPlasm0, SoundRegistry.weaponShootPlasm1, SoundRegistry.weaponShootPlasm2}, 30, 5, 15, 0.028f, new Vector2f(2.6f, 1.4f), TextureRegister.plasmSmall);
    }
