...
public class PropertyObjectArray<V extends PropertiesHolder> extends PropertyArray<V, MinimizableHolder<V>, V> {
    public PropertyObjectArray(int width, int height, String name, FontType fontType, int fontSize, int propertyOffsetX,
                               int stringOffsetY, Supplier<V> supplier, V object,
    ...
    public MinimizableHolder<V> add(V propertiesHolder) {
        ...
        MinimizableHolder<V> minimizableHolder =
                new MinimizableHolder<>(baseWidth - propertyOffsetX, baseHeight, propertiesHolder.getName(), fontType, fontSize,
