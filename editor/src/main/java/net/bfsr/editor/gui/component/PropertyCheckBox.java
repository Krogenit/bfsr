...
public class PropertyCheckBox<V extends PropertiesHolder> extends PropertyComponent<V> {
    ...
    public PropertyCheckBox(int width, int height, String name, int offsetX, int fontSize, int stringYOffset, V object, List<Field> fields, Object[] values) {
        super(new CheckBox(null, height - 2, height - 2, (boolean) values[0]), width, height, name, FontType.CONSOLA, fontSize, offsetX, 1, stringYOffset, object, fields, values);
        ...
        checkBox.setOutlineHoverColor(INPUT_OUTLINE_HOVER_COLOR_GRAY, INPUT_OUTLINE_HOVER_COLOR_GRAY, INPUT_OUTLINE_HOVER_COLOR_GRAY, 1.0f);
    }
