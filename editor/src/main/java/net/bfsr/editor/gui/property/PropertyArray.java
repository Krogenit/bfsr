...
public abstract class PropertyArray<P extends PropertiesHolder, T extends AbstractGuiObject, O> extends PropertyComponent<P> {
    ...
    protected PropertyArray(int width, int height, String name, FontType fontType, int fontSize, int propertyOffsetX,
                            int propertyOffsetY, int stringOffsetY, Supplier<O> supplier, P object, List<Field> fields,
                            Object[] values) {
