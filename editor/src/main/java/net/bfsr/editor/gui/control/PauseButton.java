...
public class PauseButton extends Button {
    ...
    public void render() {
        ...
        guiRenderer.add(centerX - xOffset - lineWidth, centerY - yOffset, lineWidth, yOffset << 1, r, g, b, a);
        guiRenderer.add(centerX + xOffset, centerY - yOffset, lineWidth, yOffset << 1, r, g, b, a);
    }
}