...
public final class ColorScheme {
    ...
    public static final Vector4f INPUT_BOX_OUTLINE_COLOR =
            new Vector4f(INPUT_OUTLINE_COLOR_GRAY, INPUT_OUTLINE_COLOR_GRAY, INPUT_OUTLINE_COLOR_GRAY, 1.0f);
    public static final Vector4f INPUT_BOX_OUTLINE_HOVER_COLOR =
    ...
    public static final Vector4f BUTTON_HOVER_COLOR =
            new Vector4f(BUTTON_HOVER_COLOR_GRAY, BUTTON_HOVER_COLOR_GRAY, BUTTON_HOVER_COLOR_GRAY, 1.0f);
    public static final Vector4f BUTTON_OUTLINE_COLOR =
    ...
    public static Button setupButtonColors(Button button) {
        button.setTextColor(TEXT_COLOR).setHoverColor(BUTTON_HOVER_COLOR).setColor(BUTTON_COLOR)
                .setOutlineColor(BUTTON_OUTLINE_COLOR).setOutlineHoverColor(BUTTON_OUTLINE_COLOR);
        return button;
    }
